  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 flex  justify-center py-8 ml-20 pt-20">
          <div className="w-full px-4 sm:px-6 lg:px-8">
            {/* Category Selection - Now on the page instead of modal */}
            {!selectedCategory && (
              <div className="bg-white w-full border border-[#3c2a98]/20 shadow rounded-lg p-6 mb-8">
                <div className="mb-6">
            ...
            {selectedCategory && (
              <div>
                ...
                {selectedCategory === ProductCategory.VISITING_CARD && (
                  <div className="bg-white border border-[#3c2a98]/20 shadow rounded-lg">

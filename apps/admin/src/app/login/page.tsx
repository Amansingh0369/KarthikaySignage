...
const Login = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-[#3c2a98] to-black">
            <div className="bg-white/90 max-w-md p-8 rounded-lg shadow-md">
                ...
                <p className="text-sm text-center mt-4 text-[#3c2a98]">By signing in, you agree to our Terms and Privacy Policy.</p>
            </div>
        </div>
    );
}

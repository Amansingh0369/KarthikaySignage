      ...
      <div className="relative z-10 ml-20 pt-10 flex justify-center items-start">
        <div className="max-w-7xl w-full px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <button
              onClick={openPopup}
              className="inline-flex items-center px-6 py-3 bg-[#e00885]/20 backdrop-blur-lg border border-[#e00885]/30 text-gray-900 font-medium rounded-lg shadow-lg hover:bg-[#e00885]/30 hover:shadow-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#e00885] focus:ring-offset-2"
            >
            ...
            <div className="mb-6 bg-[#e00885]/20 backdrop-blur-lg border border-[#e00885]/30 rounded-lg p-4">
              <div className="flex">
                <div className="flex-shrink-0">
                  <svg className="h-5 w-5 text-[#e00885]" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd" />
                  </svg>
                </div>
                <div className="ml-3">
                  <p className="text-sm text-[#e00885]">{error}</p>
                </div>
                <div className="ml-auto pl-3">
                  <button
                    onClick={() => setError(null)}
                    className="inline-flex text-[#e00885] hover:text-[#e00885]/80"
                  >
          ...
          {/* Users Table */}
          <div className="bg-white border border-[#e00885]/30 rounded-2xl shadow-xl overflow-hidden">
            <UserDetails 
              admins={admins} 
              loading={loading} 
